...
export const SEARCH_INDEX: SearchItem[] = [
  ...
  },
  {
    ...
    description: "Maximum single-account initial allocation size with scaling up to $1.2M.",
  ...
  },
  {
    id: "faq-scaling-plan",
    category: "faq",
    title: "How does account scaling work?",
    description: "Consistent analysts can scale their simulated capital allocation up to $1.2M total.",
    keywords: ["scaling", "scale", "1.2m", "allocation", "growth", "increase"],
    href: "/trading-objectives#progression",
    iconName: "HelpCircle",
    badge: "$1.2M Max",
  },
  {
  ...
  },
  {
    ...
    description: "Connect with 50,000+ traders, live announcements, and community support.",
