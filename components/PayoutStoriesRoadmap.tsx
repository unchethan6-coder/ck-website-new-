                ...
                <div className="relative z-10">
                  <div className="mb-5 flex items-start justify-between gap-4">
                    <div className="flex items-center gap-3">
                      <div className="flex size-12 items-center justify-center rounded-full bg-[#D8AD00] text-sm font-extrabold text-black">{story.initials}</div>
                      <div>
                        <p className="font-extrabold text-white">{story.name}</p>
                        <p className="text-xs text-white/55">{story.country}</p>
                      </div>
                    </div>
