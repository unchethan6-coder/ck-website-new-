...
function MetricCard({ label, target, prefix, suffix, compact, delta }: typeof metrics[number]) {
  return (
    <div className="rounded-lg border border-[#D8AD00]/20 bg-[#fffaf1] p-2.5 md:p-3">
...
function CountryCard({ flag, country, name, time, value, type }: typeof countryCards[number]) {
  return (
    <div className="country-floating-card grid grid-cols-[24px_1fr_auto] items-center gap-2 rounded-lg border border-[#D8AD00]/20 bg-[#fffaf1] p-2">
      <span className="text-base md:text-lg">{flag}</span>
      <div>
        <p className="text-[10px] font-extrabold text-[#1A1A1A] md:text-[11px]">{country}</p>
...
function FeedItem({ flag, name, meta, value }: typeof feed[number]) {
  return (
    <div className="grid grid-cols-[34px_1fr_auto] items-center gap-3 rounded-full border border-[#D8AD00]/18 bg-[#fffaf1] px-4 py-2.5 shadow-[inset_0_0_0_1px_rgba(216,173,0,0.04)]">
      <span className="text-base leading-none">{flag}</span>
      <div>
        <p className="text-xs font-extrabold leading-tight text-[#1A1A1A] md:text-sm">{name}</p>
...
export function LiveGlobalProofDashboard() {
  ...
  return (
    <section className="relative overflow-hidden bg-background px-4 py-8 md:px-6 md:py-10">
      ...
      <div className="relative mx-auto max-w-[1120px] overflow-hidden rounded-[28px] bg-[#fffaf1] p-4 shadow-[0_24px_70px_rgba(0,0,0,0.18)] md:rounded-[42px] md:p-5 lg:p-6">
        ...
        <div className="relative z-10 flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <h2 className="mt-2 max-w-2xl text-xl font-extrabold tracking-[-0.03em] text-[#1A1A1A] md:text-3xl md:leading-tight">Live Global Proof Dashboard</h2>
            ...
            <div className="mt-4 flex flex-col gap-2 sm:flex-row">
              ...
              <Link href="#payout-certificates" className="inline-flex h-8 items-center justify-center rounded-full border border-[#D8AD00]/50 bg-[#fffaf1] px-4 text-[10px] font-extrabold text-[#D8AD00]">View Live Feed</Link>
            </div>
          </div>

          <div className="inline-flex h-7 w-max items-center gap-2 rounded-full border border-[#40F285]/35 bg-[#fffaf1] px-3 text-[9px] font-extrabold text-[#40F285]"><span className="relative flex h-1.5 w-1.5"><span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[#40F285] opacity-70" /><span className="relative inline-flex h-1.5 w-1.5 rounded-full bg-[#40F285]" /></span>LIVE COUNTERS ACTIVE</div>
        </div>

        <div className="relative z-10 mt-5 rounded-xl border border-[#D8AD00]/20 bg-[linear-gradient(135deg,#fffaf1_0%,#fffaf1_55%,#fffaf1_100%)] p-2.5 md:p-3">
        ...
        <div className="relative z-10 mt-4 grid gap-3 lg:grid-cols-[1fr_1fr]">
          <div className="relative overflow-hidden rounded-xl border border-[#D8AD00]/25 bg-[linear-gradient(135deg,#fffaf1_0%,#fffaf1_55%,#fffaf1_100%)] p-3.5 md:p-4">
            ...
            <h3 className="mt-1 text-lg font-extrabold text-[#1A1A1A] md:text-xl">Live Country Counter</h3>
          ...
          <div className="rounded-xl border border-[#D8AD00]/25 bg-[linear-gradient(135deg,#fffaf1_0%,#fffaf1_55%,#fffaf1_100%)] p-4 md:p-5">
            <p className="text-[10px] font-extrabold uppercase tracking-[0.24em] text-[#D8AD00]">Real-Time Feed</p>
            <h3 className="mt-2 text-2xl font-extrabold leading-tight text-[#1A1A1A] md:text-3xl">Live Activity</h3>
            ...
            <div className="relative mt-4 h-[285px] overflow-hidden">
              ...
              <div className="pointer-events-none absolute inset-x-0 top-0 h-8 bg-gradient-to-b from-[#fffaf1] to-transparent" />
