...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#E8C547] border-t-2 border-[#1a1a1a] text-[#1a1a1a]">
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="#" className="text-[#1a1a1a] hover:text-[#333333] transition-colors">
                  Pricing
                </Link>
              </li>
              <li>
        ...
        <div className="border-t-2 border-[#1a1a1a] py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className="text-sm text-[#1a1a1a] text-center md:text-right">
        ...
        <div className="mt-8 pt-8 border-t-2 border-[#1a1a1a]">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4 text-sm text-[#1a1a1a]">
            <div>
            ...
            <div>
              <p className="font-semibold text-[#1a1a1a] mb-1">Support</p>
              <p>24/7 Support Available Mon-Fri</p>
            </div>
          </div>

          <p className="text-xs text-[#1a1a1a] text-center leading-relaxed mt-4">
