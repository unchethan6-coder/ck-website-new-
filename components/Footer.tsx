      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-16" style={{ backgroundColor: '#030303', color: '#f6eeee', paddingBottom: '89px' }}>
        ...
        <div className="pt-8">
          ...
          <div className="bg-white/5 rounded-lg p-4 mt-8" style={{ fontSize: '13px', color: '#cfc9c9', textAlign: 'left' }}>
            ...
            <p style={{ fontSize: '13px', lineHeight: '1.6' }}>The simulated trading services are provided by CK Capital. All content published or distributed by CK Capital and its affiliated entities (collectively, the "Company") is provided for general informational and educational purposes only.</p>
            ...
            <p style={{ fontWeight: '700', fontSize: '15px', marginTop: '12px', lineHeight: '1.4' }}>Fees collected by the Company are used to support business operations, including but not limited to:</p>
            <ul style={{ marginLeft: '16px', marginTop: '4px', lineHeight: '1.6' }}>
              <li style={{ fontSize: '13px', marginBottom: '3px' }}>Technology infrastructure</li>
              <li style={{ fontSize: '13px', marginBottom: '3px' }}>Trading platform development and maintenance</li>
              <li style={{ fontSize: '13px', marginBottom: '3px' }}>Software licensing</li>
              <li style={{ fontSize: '13px', marginBottom: '3px' }}>Risk management systems</li>
              <li style={{ fontSize: '13px', marginBottom: '3px' }}>Customer support</li>
              <li style={{ fontSize: '13px', marginBottom: '3px' }}>Administrative operations</li>
              <li style={{ fontSize: '13px', marginBottom: '3px' }}>Staffing and business expenses</li>
            </ul>
            
            <p style={{ fontSize: '13px', marginTop: '8px', lineHeight: '1.6' }}>Payment of a program fee grants access only to simulated trading evaluations and associated services.</p>
            
            <h2 style={{ fontWeight: '700', fontSize: '15px', marginTop: '12px', lineHeight: '1.4' }}>No Offer or Solicitation</h2>
            <p style={{ fontSize: '13px', lineHeight: '1.6' }}>Nothing contained on this website, within our programs, or in any communication issued by CK Capital constitutes an offer or solicitation to buy or sell forex, CFDs, futures, options, stocks, cryptocurrencies, or any other financial instruments.</p>
            
            <p style={{ fontSize: '13px', marginTop: '8px', lineHeight: '1.6' }}>Any trading results, performance statistics, payout examples, or testimonials displayed are based on simulated trading activities and should not be interpreted as guarantees of future performance.</p>
            
            <p style={{ fontSize: '13px', marginTop: '8px', lineHeight: '1.6' }}>Past simulated performance is not necessarily indicative of future results.</p>
            
            <h2 style={{ fontWeight: '700', fontSize: '15px', marginTop: '12px', lineHeight: '1.4' }}>General Risk Warning</h2>
            <p style={{ fontSize: '13px', lineHeight: '1.6' }}>Trading financial markets involves significant risk and is not suitable for every individual. Even within a simulated environment, trading strategies may produce results that differ substantially from real-market conditions due to factors such as liquidity, execution, slippage, and market volatility.</p>
            
            <p style={{ fontSize: '13px', marginTop: '8px', lineHeight: '1.6' }}>Participants should carefully consider their objectives, experience, and risk tolerance before participating in any evaluation program.</p>
            
            <p style={{ fontSize: '13px', marginTop: '8px', lineHeight: '1.6' }}>No representation is made that any participant will achieve profits or similar results.</p>
            
            <h2 style={{ fontWeight: '700', fontSize: '15px', marginTop: '12px', lineHeight: '1.4' }}>Intellectual Property</h2>
            <p style={{ fontSize: '13px', lineHeight: '1.6' }}>All website content, branding, educational materials, software, graphics, logos, and proprietary technologies are the exclusive property of CK Capital or its licensors and are protected by applicable intellectual property laws. Unauthorized reproduction, distribution, modification, or commercial use is strictly prohibited without prior written consent.</p>
            
            <h2 style={{ fontWeight: '700', fontSize: '15px', marginTop: '12px', lineHeight: '1.4' }}>Jurisdiction Restrictions</h2>
            <p style={{ fontSize: '13px', lineHeight: '1.6' }}>CK Capital reserves the right to restrict or deny access to its services in jurisdictions where participation would violate applicable laws or regulations. Services may not be available to residents of certain countries or regions subject to international sanctions or regulatory restrictions. Users are responsible for ensuring compliance with their local laws before accessing or using the Company's services.</p>
            
            <h2 style={{ fontWeight: '700', fontSize: '15px', marginTop: '12px', lineHeight: '1.4' }}>Corporate Information</h2>
            <p style={{ fontSize: '13px', lineHeight: '1.6' }}>CK Capital provides simulated trader evaluation programs and educational services only. The Company does not provide brokerage services, investment management services, or financial advisory services through this website.</p>
            
            <h3 style={{ fontWeight: '700', fontSize: '15px', marginTop: '12px', lineHeight: '1.4' }}>Registered Office Address</h3>
            <p style={{ fontSize: '13px', lineHeight: '1.5', marginTop: '8px' }}>CK Capital Group Ltd, 1 Allied Business Centre, Coldharbour Lane, Harpenden, Hertfordshire AL5 4UT, England, United Kingdom</p>
            
            <h2 style={{ fontWeight: '700', fontSize: '15px', marginTop: '12px', lineHeight: '1.4' }}>Disclaimer</h2>
            <p style={{ fontSize: '13px', lineHeight: '1.6', marginTop: '8px' }}>By accessing this website or participating in any CK Capital program, you acknowledge that you understand the simulated nature of the services provided and agree to the applicable Terms & Conditions, Privacy Policy, and all other governing legal documents.</p>
            
            <p style={{ fontSize: '13px', lineHeight: '1.4', marginTop: '8px' }}>Nothing contained on this website or within any CK Capital program shall be construed as financial, investment, legal, or tax advice, or as an offer or solicitation to engage in any investment activity.</p>
          </div>
        </div>
      </div>
    </footer>
