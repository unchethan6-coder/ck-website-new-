          ...
          <div className="mt-5 space-y-4">
            ...
            <div className="rounded-xl border border-white/10 bg-black/40 p-4">
              <div className="grid grid-cols-3 gap-2 relative">
                {/* Step 1: Skipped */}
                <div className="rounded-lg border border-white/5 bg-white/[0.02] p-2.5 text-center relative overflow-hidden">
                  ...
                  <p className="mt-1 text-[11px] font-extrabold text-foreground/50">8% Target</p>
                ...
                <div className="rounded-lg border border-white/5 bg-white/[0.02] p-2.5 text-center relative overflow-hidden">
                  ...
                  <p className="mt-1 text-[11px] font-extrabold text-foreground/50">5% Target</p>
                  <span className="mt-1.5 inline-block rounded bg-white/5 px-1.5 py-0.5 text-[8.5px] font-mono text-foreground/40">
                    SKIPPED
                  </span>
                </div>
                ...
                <div className="rounded-lg border border-primary/40 bg-primary/10 p-2.5 text-center relative overflow-hidden shadow-[0_0_15px_rgba(212,175,55,0.15)]">
                  ...
                  <p className="mt-1 text-[11px] font-extrabold text-foreground">Day 1 Payouts</p>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="rounded-xl border border-primary/30 bg-primary/[0.05] p-3 text-left">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-bold text-foreground">Profit Target</span>
                </div>
                <p className="mt-1.5 font-mono text-base font-extrabold text-emerald-400">NO TARGET</p>
                <p className="text-[10px] text-foreground/50">Keep your profits from trade #1</p>
              </div>

              <div className="rounded-xl border border-white/10 bg-white/[0.02] p-3 text-left">
                <div className="flex items-center gap-2">
                  <ShieldAlert size={16} className="text-secondary" />
                  <span className="text-xs font-bold text-foreground">Max Loss Shield</span>
                </div>
                <p className="mt-1.5 font-mono text-base font-extrabold text-foreground">6% Static Max</p>
                <p className="text-[10px] text-foreground/50">Trailing lock protection enabled</p>
              </div>
            </div>
