...
export function FeatureStrip() {
  ...
  return (
    <section
      className="relative z-20 border-y border-white/[0.08] bg-[#050505] py-10 sm:py-12"
      data-od-id="feature-strip"
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-5 lg:gap-8 lg:divide-x lg:divide-white/[0.08]">
          {features.map((item) => (
            <div
              key={item.title}
              className="group flex items-start gap-4 px-2 sm:px-4 cursor-default transition-transform duration-200 hover:-translate-y-0.5"
            >
              ...
              <div className="text-left">
                <h4 className="font-[family-name:var(--font-inter-tight)] text-[14px] font-black text-white group-hover:text-[#FFC107] transition-colors duration-150">
                  {item.title}
                </h4>
