  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="sm:max-w-md max-w-[90vw] w-full gap-0 p-0 border-0 rounded-2xl overflow-hidden">
        {/* Close Button */}
        <DialogClose asChild>
          <button className="absolute right-4 top-4 z-50 p-1 hover:bg-gray-100 rounded-lg transition-colors">
              ...
              <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4 pt-2 sm:pt-4">
                <div>
                  <input
                    ...
                    required
                    className="w-full px-4 sm:px-5 py-2.5 sm:py-3 rounded-lg bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-0 text-sm sm:text-base transition-all"
                  />
                </div>
                ...
                <Button
                  ...
                  className="w-full bg-gray-900 hover:bg-gray-800 text-white font-bold py-2.5 sm:py-3 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
                >
