    ...
    <>
      ...
      <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-[calc(100%-2rem)] max-w-md max-h-[90vh] overflow-y-auto sm:max-h-none sm:overflow-visible">
        <div
          ...
          style={{ borderColor: '#FFD700', backgroundColor: '#ffffff', backgroundImage: 'url("https://d8j0ntlcm91z4.cloudfront.net/user_3DDBO5ZLldZQZLxxyVBdiTQXCB0/hf_20260615_095616_05fe23c6-d2fc-4390-b055-ada610dfdfe7.png")', backgroundSize: 'cover', backgroundPosition: 'center' }}
        >
          {/* Close Button */}
          <button
            onClick={() => setIsOpen(false)}
