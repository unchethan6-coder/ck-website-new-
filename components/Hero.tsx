...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-white px-4 py-16 md:py-32">
      <div className="container mx-auto max-w-6xl">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-slide-left">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#1a1a1a] leading-tight mb-8 text-balance">
            ...
            <div className="grid grid-cols-3 gap-4 mb-12">
              <div className="bg-[#F9F9F9] p-4 rounded-lg shadow-premium">
                <div className="flex items-center gap-2 mb-2">
                  <TrendingUp className="h-5 w-5 text-[#E8C547]" />
                  <span className="font-bold text-xl text-[#1a1a1a]">100%</span>
                </div>
                <p className="text-sm text-[#666666]">Profit Split</p>
              </div>
              <div className="bg-[#F9F9F9] p-4 rounded-lg shadow-premium">
                <div className="flex items-center gap-2 mb-2">
                  <DollarSign className="h-5 w-5 text-[#E8C547]" />
                  <span className="font-bold text-xl text-[#1a1a1a]">$1.2M</span>
                </div>
                <p className="text-sm text-[#666666]">Max Funded</p>
              </div>
              <div className="bg-[#F9F9F9] p-4 rounded-lg shadow-premium">
                <div className="flex items-center gap-2 mb-2">
                  <BarChart3 className="h-5 w-5 text-[#E8C547]" />
                  <span className="font-bold text-xl text-[#1a1a1a]">50+</span>
                </div>
                <p className="text-sm text-[#666666]">Instruments</p>
              </div>
            </div>
