    ...
    <div className="min-h-screen bg-white py-12 px-4 md:py-20">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-lg text-muted-foreground">Get answers to common questions about CK Capital prop trading</p>
        </div>

        <div className="space-y-6 md:space-y-8">
          {/* What is CK Capital */}
          <div className="border border-gray-300 rounded-lg p-6 hover:border-primary transition-colors">
            <h2 className="text-xl font-bold text-foreground mb-3">What is CK Capital?</h2>
          ...
          <div className="border border-gray-300 rounded-lg p-6 hover:border-primary transition-colors">
            <h2 className="text-xl font-bold text-foreground mb-3">How do prop trading accounts work?</h2>
          ...
          {/* Profit Splits */}
          <div className="border border-gray-300 rounded-lg p-6 hover:border-primary transition-colors">
            <h2 className="text-xl font-bold text-foreground mb-3">What profit splits do you offer?</h2>
            <p className="text-gray-700">
          ...
          {/* Starting costs */}
          <div className="border border-gray-300 rounded-lg p-6 hover:border-primary transition-colors">
            <h2 className="text-xl font-bold text-foreground mb-3">How much does it cost to start?</h2>
            <p className="text-gray-700">
          ...
          {/* Account Sizes */}
          <div className="border border-gray-300 rounded-lg p-6 hover:border-primary transition-colors">
            <h2 className="text-xl font-bold text-foreground mb-3">What account sizes are available?</h2>
            <p className="text-gray-700 mb-3">
          ...
          {/* Platforms supported */}
          <div className="border border-gray-300 rounded-lg p-6 hover:border-primary transition-colors">
            <h2 className="text-xl font-bold text-foreground mb-3">What platforms do you support?</h2>
            <p className="text-gray-700">
          ...
          {/* Trading instruments */}
          <div className="border border-gray-300 rounded-lg p-6 hover:border-primary transition-colors">
            <h2 className="text-xl font-bold text-foreground mb-3">What can I trade?</h2>
            <p className="text-gray-700 mb-3">
          ...
          {/* News trading */}
          <div className="border border-gray-300 rounded-lg p-6 hover:border-primary transition-colors">
            <h2 className="text-xl font-bold text-foreground mb-3">Can I trade the news?</h2>
            <p className="text-gray-700">
          ...
          {/* Withdrawals */}
          <div className="border border-gray-300 rounded-lg p-6 hover:border-primary transition-colors">
            <h2 className="text-xl font-bold text-foreground mb-3">How do withdrawals work?</h2>
            <p className="text-gray-700">
          ...
          {/* Daily loss limits */}
          <div className="border border-gray-300 rounded-lg p-6 hover:border-primary transition-colors">
            <h2 className="text-xl font-bold text-foreground mb-3">What are the daily loss limits?</h2>
            <p className="text-gray-700">
          ...
          {/* Evaluation time */}
          <div className="border border-gray-300 rounded-lg p-6 hover:border-primary transition-colors">
            <h2 className="text-xl font-bold text-foreground mb-3">How long is the evaluation process?</h2>
            <p className="text-gray-700">
          ...
          <div className="border border-gray-300 rounded-lg p-6 hover:border-primary transition-colors">
            <h2 className="text-xl font-bold text-foreground mb-3">Is there customer support?</h2>
            <p className="text-gray-700">
          ...
          {/* Minimum experience */}
          <div className="border border-gray-300 rounded-lg p-6 hover:border-primary transition-colors">
            <h2 className="text-xl font-bold text-foreground mb-3">What trading experience do I need?</h2>
            <p className="text-gray-700">
          ...
          <div className="border border-gray-300 rounded-lg p-6 hover:border-primary transition-colors">
            <h2 className="text-xl font-bold text-foreground mb-3">Are there geographic restrictions?</h2>
            <p className="text-gray-700">
          ...
          {/* Account types */}
          <div className="border border-gray-300 rounded-lg p-6 hover:border-primary transition-colors">
            <h2 className="text-xl font-bold text-foreground mb-3">What are the different challenge types?</h2>
            <p className="text-gray-700 mb-3">
          ...
          <div className="bg-yellow-50 border-l-4 border-yellow-400 p-6 rounded">
            <h2 className="text-xl font-bold text-foreground mb-3">Ready to start your prop trading journey?</h2>
            ...
            <button className="bg-primary hover:bg-primary/90 text-foreground font-bold py-2 px-6 rounded-lg transition-colors">
