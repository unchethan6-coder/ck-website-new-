...
export const metadata = pageSeo({
  ...
  description:
    "CK Capital Return and Dispute Policy - Information about refunds and chargebacks.",
  path: "/return-policy",
});
...
export default function ReturnPolicyPage() {
  return (
    <div className="min-h-screen bg-background" data-od-id="return-page">
      ...
      {/* ─────────────── Hero ─────────────── */}
      <section className="relative bg-background" data-od-id="return-hero">
        <div
          aria-hidden="true"
        ...
        <Container className="relative py-16 md:py-20">
          <div className="max-w-3xl">
            ...
            >
              Return <span className="shimmer-text">Policy</span>
            </h1>
          </div>
        </Container>
      </section>
      ...
      {/* ─────────────── Document ─────────────── */}
      <section className="bg-background pb-16 md:pb-24" data-od-id="return-document">
        <Container>
