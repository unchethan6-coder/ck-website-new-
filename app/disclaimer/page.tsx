  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto max-w-4xl px-4 py-12 sm:py-16 md:py-20">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-foreground mb-8 text-balance">
        ...
        <div className="space-y-8 text-gray-700">
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">Simulated Trading Environment</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">Educational & Evaluation Services Only</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">Performance Disclaimer</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">Hypothetical Performance Disclosure</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">Fees & Payments</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">Restricted Jurisdictions</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">No Guaranteed Income</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">Trading and Investment Risks</h2>
            <p className="leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">Before Deciding to Participate</h2>
            <p className="leading-relaxed">
          ...
          <section>
            ...
            <div className="bg-muted p-4 sm:p-6 rounded border border-border space-y-2 text-sm sm:text-base">
        ...
        <div className="mt-12 pt-8 border-t border-border text-xs sm:text-sm text-muted-foreground">
