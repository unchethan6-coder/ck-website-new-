    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <h2 className="section-title text-foreground mb-12 text-center">Why Choose Instant Funding?</h2>
      ...
      <section className="py-16 bg-card/20">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <h2 className="section-title text-foreground mb-12 text-center">Instant Funding Prices</h2>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          <h2 className="section-title text-foreground mb-12 text-center">Instant vs Challenge</h2>
      ...
      <section className="py-16 bg-card/20">
        <div className="max-w-3xl mx-auto px-4 md:px-6">
          ...
          <div className="space-y-4">
            {[
              { q: 'How quickly can I start trading?', a: 'You can be trading within minutes of purchase. Instant Funding accounts are activated immediately.' },
              { q: 'What are the rules for Instant Funding?', a: 'Max Daily Loss: 3%, Max Loss: 5%, Consistency: 20%. Much more relaxed than challenge evaluations.' },
              { q: 'Can I upgrade my account size?', a: 'Yes. As you prove profitability, you can upgrade to larger account sizes up to $1.2M simulated capital.' },
              { q: 'What if I lose my account?', a: 'You can reset and try again. We offer reset options to give you another opportunity to succeed.' },
            ].map((item, idx) => (
