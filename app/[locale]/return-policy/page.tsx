...
export default async function ReturnPolicyPage() {
  ...
  return (
    <div className="min-h-screen bg-background" data-od-id="return-page">
      ...
      {/* ─────────────── Hero (DARK) ─────────────── */}
      <section className="relative isolate -mt-[72px] md:-mt-[76px] overflow-hidden border-b border-foreground/[0.07] bg-[#070709] pt-28 md:pt-36 pb-14 md:pb-20 text-white" data-od-id="return-hero">
      ...
      {/* ─────────────── Document (LIGHT) ─────────────── */}
      <section className="bg-[#F6F7F9] py-12 md:py-20 text-[#111827]" data-od-id="return-document">
